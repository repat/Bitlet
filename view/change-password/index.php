<div class=" container well profile bitletDropShadow roundedCorners" id="leftCol"> 
	<div class="settingsLeftContent">	
		<div class="span4" style="margin-left:0px !important;">	
			...
			<p class="">Old Password:<input class="input focused" id="oldPassword" type="password" value=""></p>
		
			
		<div class="sideTip" id="passTipOld">
			<p class="isaok hide"><i class="icon-ok"></i></p>	
			<p class="invalid hide"><i class="icon-remove"></i> Does not match our records</p>	
		</div>
		<div style="clear:both;"></div>	


	<p class="">New Password:<input class="input focused" id="newPass1" type="password" value=""></p>
	...
	<p class="">Confirm Password:<input class="input focused" id="newPass2" type="password" value=""></p>
