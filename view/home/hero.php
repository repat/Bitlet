...
<div class="tagline-descr">
	<div class="quote-placement">
		<div class="quote-background">
			...
			<tr>
				<th style="width:300px; vertical-align:text-top;"><h3> Just fill in your email, and upload a file you want to sell.</h3></th>
				<th style="width:470px; vertical-align:text-top;"><h3>We give you a link you can Pin, Tweet, post to Facebook, or email out. Anyone with the link can buy your product. </h3></th>
				<th style="width:300px; vertical-align:text-top;" ><h3>Once you're ready to collect your profits, simply click "check out". </h3></th>
			</tr>
			</table>
			<hr class="index-bar">
			
				<form  style="text-align:left;" class="form-inline" target="upload_iframe" id="upload" action="/ajax/upload" method="post" enctype="multipart/form-data">
...
<div id="tagline-image">
	...
	<div id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
			<div class="active item"> <img class="carouselImage" src="img/bg/musician.jpg"> </div>
